...
public class PortForwarding {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            LocalPortForwarder lpf1 = conn.createLocalPortForwarder(8080, "127.0.0.1", 80);
            ...
            conn.requestRemotePortForwarding("127.0.0.1", 8081, "127.0.0.1", 80);
            ...
            conn.cancelRemotePortForwarding(8081);
