...
public class SwingShell {
     ...
     */
    static final String knownHostPath = "/Users/chinaxiang/.ssh/known_hosts";
    static final String idDSAPath     = "/Users/chinaxiang/.ssh/id_dsa";
    static final String idRSAPath     = "/Users/chinaxiang/.ssh/id_rsa";
                ...
                while (true) {
                    if ((enableDSA || enableRSA) && conn.isAuthMethodAvailable(username, "publickey")) {
                        if (enableDSA) {
                            ...
                            if (key.exists()) {
                                EnterSomethingDialog esd = new EnterSomethingDialog(loginFrame, "DSA Authentication", new String[] { lastError, "Enter DSA private key password:" },
                                    true);
                                esd.setVisible(true);
                        ...
                        if (enableRSA) {
                            ...
                            if (key.exists()) {
                                EnterSomethingDialog esd = new EnterSomethingDialog(loginFrame, "RSA Authentication", new String[] { lastError, "Enter RSA private key password:" },
                                    true);
                                esd.setVisible(true);
                                boolean res = conn.authenticateWithPublicKey(username, key, esd.answer);
                                if (res == true)
